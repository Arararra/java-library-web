...
@WebServlet(name = "TransactionFinishServlet", urlPatterns = {"/transaction/finish/*"})
public class TransactionFinishServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String err = transactionController.finishTransaction(trxId);
        if (err == null) {
            request.getSession().setAttribute("successMessage", "Transaksi berhasil diselesaikan.");
        } else {
