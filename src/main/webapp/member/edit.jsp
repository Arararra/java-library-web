...
import="com.tugas.perpus.model.Member" %> <% request.setAttribute("title", "Edit
Member"); Member member = (Member) request.getAttribute("member"); %>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
              ...
              <form
                method="POST"
                action="<%= request.getContextPath() %>/category/delete/<%= category.getId() %>"
            ...
            <div class="card shadow mb-4">
              <div class="card-body justify-content-end">
                <form
                  method="POST"
                  action="<%= request.getContextPath() %>/category/edit/<%= category.getId() %>"
